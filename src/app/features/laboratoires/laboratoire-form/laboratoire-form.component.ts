...
export class LaboratoireFormComponent {
  ...
  private placeMarker(pos: { lat: number; lng: number }): void {
    ...
    this.mapMarker = new google.maps.Marker({
      ...
      icon: { path: google.maps.SymbolPath.CIRCLE, scale: 10, fillColor: '#0D6E6E', fillOpacity: 1, strokeColor: '#ffffff', strokeWeight: 2 },
    });
  ...
  annuler(): void { this.router.navigate(['/admin/laboratoires']); }
  ...
  enregistrer(): void {
    ...
    this.http.post(`${this.api}/admin/laboratories`, payload)
